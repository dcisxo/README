# Hi, I'm Damian Campos 👋

Full-stack developer and TripleTen Software Engineering graduate. I enjoy building practical, user-focused web applications — from intuitive UIs to RESTful APIs and cloud-deployed backends.
...
**Frontend**
`HTML` `CSS` `JavaScript (ES6+)` `React 18` `React Router` `Vite` `BEM` `Responsive Design`

**Backend**
`Node.js` `Express` `MongoDB` `Mongoose` `JWT Authentication`

**Tools & Platforms**
`Git` `GitHub` `Google Cloud (Compute Engine)` `Nginx` `PM2`
